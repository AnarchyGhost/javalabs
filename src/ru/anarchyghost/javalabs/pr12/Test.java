...
public class Test {
    public static void main(String[] args){
        Person person=new Person("Konstantin","Dmitrievich","Markelov");
        System.out.println(person.fio());
        Person person1=new Person("Konstantin");
        System.out.println(person1.fio());

        Adress adress=new Adress("Russia,  Bryanskaya, Bryansk--, Svyazistov() 18, 12, 7");
        ...
        System.out.println(new PhoneNumber("+79964483276"));

        Last last=new Last("Мак КаМ Рам");
